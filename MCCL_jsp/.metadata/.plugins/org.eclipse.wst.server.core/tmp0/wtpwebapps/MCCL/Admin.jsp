      ...
      <div class="col-md-offset-1 col-md-10">
        ...
        <div class="panel-heading">
          <ul class="nav nav-pills ">
            <li><a href="Admin.jsp"><span class="glyphicon glyphicon-home"></span> <b> Trang Chủ</b></a></li>
      ...
      <div id="home2" class="tab-pane fade">
        ...
        <!-- the hien thong tin cua user ra bang -->
          <tr >
            ...
            <td><center><a href=""><button type="button" id="btnSua" class="btn btn-info ">Sửa</button></a></center></td>
            <td><center><a href=""><button type="button" id="btnXoa" class="btn btn-danger ">Xóa</button></a></center></td>
            <td><center><a href=""><button type="button" id="btnKhoa" class="btn btn-warning ">Khóa</button></a></center></td>
          </tr>
          <tr >
       ...
       <!-- button them user moi, goi den newuser.jsp -->
         <a href="Update_ND.jsp"><button type="button" id="btnThem" class="btn btn-primary">Thêm</button></a>
      </div>
