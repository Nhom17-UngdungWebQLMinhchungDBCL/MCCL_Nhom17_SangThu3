    ...
    <div class="col-md-offset-1 col-md-10">
        <div>
		   <ul class="nav nav-tabs" role="tablist">
            <li class="active"><a href="NMC.jsp">Trang Chủ</a></li>
            <li><a href="ThongTinCaNhan_NMC.jsp">Thông Tin Cá Nhân</a></li>
            <li><a href="MucMC_NMC.jsp">Mục Minh Chứng Phụ Trách</a></li>
            <li><a href="DoiMK_NMC.jsp">Đổi mật khẩu</a></li>
           </ul>
        </div>
    </div>
    </div>
...
<div class="container">
  ...
  <div class="panel-heading">Danh Sách Minh Chứng Phụ Trách</div>
  <div class="panel-body">
       <table class="table table-bordered">
          ...
          <tbody>
           ...
           <tbody>
               <tr>
                  ...
                  <td>Minh Chứng 2</td>
                  <td>XYZ</td>
                  <td>Kiểm tra hoạt động tuyển sinh</td>
                  <td>Hình Ảnh</td>
                  <td>Nguyễn Văn B</td>
              </tr>
          </tbody>
           <tbody>
               <tr>
                  ...
                  <td>Minh Chứng 1</td>
                  <td>CDE</td>
                  <td>Kiểm tra việc tổ chức các kì thi</td>
                  <td>Văn Bản</td>
                  <td>Nguyễn Văn A</td>
              </tr>
          </tbody>
          ...
          <tbody>
               <tr>
                  ...
                  <td>Minh Chứng 2</td>
                  <td>MLC</td>
                  <td>Các bản kế hoạch trong năm học tới</td>
                  <td>Văn Bản</td>
                  <td>Nguyễn Văn C</td>
              </tr>
          </tbody>
